...
exports.LazyimgWrapper = exports.ID = void 0;
var react_1 = require("react");
require("intersection-observer");
var Util_1 = require("./Util");
exports.ID = Date.now() + '';
var Lazyimg = function (props) {
    var _a = props.force, force = _a === void 0 ? false : _a, _b = props.element, element = _b === void 0 ? 'img' : _b, _c = props.placeholder, placeholder = _c === void 0 ? 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC' : _c, _d = props.animateType, animateType = _d === void 0 ? 'transition' : _d, animateClassName = props.animateClassName, _e = props.isLazyimgWrapper, isLazyimgWrapper = _e === void 0 ? false : _e, _f = props.timeout, timeout = _f === void 0 ? 300 : _f, parent = props.parent, src = props.src, srcSet = props.srcSet, _g = props.root, root = _g === void 0 ? null : _g, _h = props.rootMargin, rootMargin = _h === void 0 ? '0px' : _h, _j = props.threshold, threshold = _j === void 0 ? 0 : _j, children = props.children, _k = props.loaded, loaded = _k === void 0 ? function () { } : _k, _l = props.end, end = _l === void 0 ? function () { } : _l, restProps = __rest(props, ["force", "element", "placeholder", "animateType", "animateClassName", "isLazyimgWrapper", "timeout", "parent", "src", "srcSet", "root", "rootMargin", "threshold", "children", "loaded", "end"]);
    ...
    var _m = react_1.useState(false), animated = _m[0], setAnimated = _m[1];
    var _o = react_1.useState(false), isLoaded = _o[0], setIsLoaded = _o[1];
    ...
    if (isLoaded || force) {
        ...
        if (react_1.isValidElement(placeholder)) {
            ...
            currentReactElement.current = react_1.cloneElement(placeholder, __assign(__assign({}, LazyimgProps), { style: __assign(__assign({}, style), placeholder.props.style) }));
        }
        else {
            if (element === 'img') {
...
var LazyimgWrapper = function (_a) {
    var _b = _a.element, element = _b === void 0 ? 'div' : _b, children = _a.children, restProps = __rest(_a, ["element", "children"]);
    var cloneChildren = react_1.Children.only(children);
    if (!!children) {
        cloneChildren = react_1.cloneElement(cloneChildren, { isLazyimgWrapper: true });
    }
    return react_1.createElement(element, __assign({ style: { position: 'relative' } }, restProps), cloneChildren);
};
